...
def schedule(studio_num, period_num, rehearsal_num, table_name):
    bands = fetch_bands_from_dynamodb(table_name)
    ...
    for band_name, count in band_rehearsal_counts.items():
        print(f"band: {band_name}: {count}")
